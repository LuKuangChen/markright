...
let evaluator: dict<Markright__Extension.t> = Dict.fromArray([
...
let toHTMLString = (document, ~extensions: dict<Markright__Extension.t>=Dict.make()): string => {
...
let compile = (document, ~extensions: dict<Markright__Extension.t>=Dict.make()) => {
  document
  ->parseDocument
